...
public class Foil extends Frame implements WindowListener {
   ...
   public Foil() {
     ...
     offImg2 = createImage(this.getSize().width,
                      this.getSize().height) ;
     off2Gg = offImg2.getGraphics() ;
     offImg3 = createImage(this.getSize().width,
                      this.getSize().height) ;
...
*/
  ...
  class Con extends Panel {
     ...
     Con (Foil target) { 
       ...
       add(new Label(" Version 1.4b", Label.LEFT));
       add(l1) ;
 ...
 // Drag value
     ...
     class Perf extends Panel {
        ...
        Perf (Foil target) {
           ...
           prnt.appendText("FoilSim III 1.3a beta - 27 July 10 ") ;
           add(prnt) ;
        }
     }  // Perf
  } // Out 
